...
public class EncryptUtils {
	...
	private static final String KEY = ApplicationContextUtil
			.getProperty("encryptionkey");
	private static final String ALGORITHM = ApplicationContextUtil
			.getProperty("encryptionalgorithm");
	private static final String CIPHER_PARAMETERS = ApplicationContextUtil
			.getProperty("cipherparameters");
	...
	private static void init() {
		EncryptUtils.binHexToBytes(KEY_LOWER, KEY_BYTES, 0, KEY_BYTES.length);
	}
